---
title: Units & Rulers Preferences
date: 2026-04-20 00:00:00 +0000
categories: [Photoshop, Basics]
tags: [units, rulers, resolution, print, digital]
---
...
- [x] Rulers: Pixels (Recommended for Web/UI)
- [x] Type: Points
- [x] Print Resolution: 300 Pixels/Inch
- [x] Screen Resolution: 72 Pixels/Inch
- [x] Point/Pica Size: PostScript (72 points/inch)

##### Under the Units Section

- [x] **1. Rulers**
*(Sets the primary measurement unit for your canvas)*
...
- [x] **2. Type**
*(Sets the measurement for your font sizes)*
...
- [x] **3. Print Resolution: 300 Pixels/Inch**
*(The industry standard for high-quality print)*
...
- [x] **4. Screen Resolution: 72 Pixels/Inch**
*(The standard for web and digital displays)*
