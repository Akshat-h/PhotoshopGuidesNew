---
title: Guides, Grid & Slices
date: 2026-04-20 00:00:00 +0000
categories: [Photoshop, Tools]
tags: [guides, grid, layout, alignment]
---
...
- [x] Canvas Guides: Cyan (Solid Line)
- [x] Smart Guides: Magenta
- [x] Grid: Custom Gray (2cm Every / 4 Subdivisions)
- [x] Show Slice Numbers: Enabled
- [x] Path Options: 1px (Default Blue)

##### Under the Guides Section

- [x] **1. Canvas & Artboard Guides**
*(Customizes your manual layout lines)*
...
- [x] **2. Smart Guides**
*(The ultimate tool for instant alignment)*
...
- [x] **3. Gridline Every & Subdivisions**
*(Sets up your underlying alignment matrix)*
...
- [x] **4. Slices & Slice Numbers**
*(For web asset exporting)*
...
- [x] **5. Path & Control Colors**
*(Visibility for Pen Tool and Transform handles)*
