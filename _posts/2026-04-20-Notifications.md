...
tags: [tooltips, quiet mode, notifications]
---
## Notifications Preferences: Managing Tooltips and Pop-ups
...
- [ ] Tooltips (Optional)
- [x] Enable quiet mode (Highly Recommended)
  - *Note: Enabling quiet mode automatically disables the three settings below it.*
  - [ ] Rich Tooltips
  - [ ] What's new
  - [ ] Feature Onboarding
...
- [ ] **1. Uncheck "Tooltips" (Optional)**
*(Disables the standard hover text labels)*
...
- [x] **2. Check "Enable quiet mode"**
*(Pauses in-app notifications and disables annoying pop-ups)*
...
- [ ] **3. Uncheck "Rich Tooltips"**
Instead of a simple text box, Rich Tooltips display a large 5-second video demonstration. These video pop-ups take up too much screen space and add unnecessary processing overhead.

- [ ] **4. Uncheck "What's new"**
Prevents promotional windows from popping up over your home screen showcasing the latest Adobe features.

- [ ] **5. Uncheck "Feature Onboarding"**
Disables step-by-step educational workflow tours from interrupting you directly inside your active workspace.
