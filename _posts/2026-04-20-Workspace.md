...
- [x]  Auto-Show Hidden Panels
- [x]  Open Documents as Tabs
- [x]  Enable Floating Document Window Docking
- [x]  Large Tabs
- [ ] Align UI according to OS settings
- [ ] Enable Narrow Options Bar

##### Under the Options Section

- [ ] **1. Uncheck "Auto-Collapse Iconic Panels" (Personal Preference)**
*(Keeps your workspace clean and maximizes canvas area)*
...
- [x] **2. Check "Auto-Show Hidden Panels"**
*(Improves workflow when using the 'Hide Panels' shortcut)*
...
- [x] **3. Check "Open Documents as Tabs"**
...
- [x] **4. Check "Enable Floating Document Window Docking"**
*(Allows easy snapping of floating windows)*
...
- [ ] **6. Uncheck "Align UI according to OS settings" (Personal Preference)**
*(Prevents weird UI scaling issues)*
...
- [ ] **7. Check "Enable Narrow Options Bar" (Personal Preference)**
*(Condenses tool settings for smaller screens)*
